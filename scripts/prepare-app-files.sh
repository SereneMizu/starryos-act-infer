...
install -Dm0644 "$root/output/test/reference.json" "$dst/reference.json"

rm -rf "$dst/frames"
mkdir -p "$dst/frames"
cp "$root/output/dataset/videos/observation.images.fpv/chunk-000/frame_000000.jpg" "$dst/frames/"
cp "$root/output/dataset/videos/observation.images.fpv/chunk-000/frame_000227.jpg" "$dst/frames/"
